...
// server.use('/api/website/products', router) // this is common route of this file
// }

// routes/website/productRoute.js
const express = require('express');
const router = express.Router();

// Import controller + middleware
const { view } = require('../../controllers/website/products_controller');
const upload = require('../../middlewares/upload');

// Routes
router.post('/view', upload('products').none(), view);

// Export route function
module.exports = (server) => {
  server.use('/api/website/products', router);
};
