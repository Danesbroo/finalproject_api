...
// server.use('/api/website/category', router) // this is common route of this file
// }

// routes/website/categoryRoute.js
const express = require('express');
const router = express.Router();

// Import controller + middleware
const { view } = require('../../controllers/website/category_controller');
const upload = require('../../middlewares/upload');

// Routes
router.post('/view', upload('category').none(), view);
