...
const { decompose, changeStatus, details, update, view, create } = require('../../controllers/admin/color_controller');
...
server.use('/api/admin/color', router) // this is common route of this file
}