...
const { decompose, changeStatus, details, update, view, create } = require('../../controllers/admin/material_controller');
...
server.use('/api/admin/material', router) // this is common route of this file
}